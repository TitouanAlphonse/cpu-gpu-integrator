...
extern double in_SM(double m);  // gives the mass in number of solar mass
extern double in_JM(double m);  // gives the mass in number of Jupiter mass
extern double in_SR(double d);  // gives the distance in number of Sun radius
extern double in_JR(double d);  // gives the distance in number of Jupiter radius
